    ...
    <div className="min-h-screen bg-[#060b14] bg-grid flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md animate-fade-up">
        ...
        <div className="bg-[#0a1120] border border-[rgba(34,211,238,0.1)] rounded-2xl p-8">
          <h1 className="font-['Syne'] text-2xl font-bold text-white mb-1">Welcome back</h1>
          <p className="text-[#7a8fa6] text-sm mb-8">Sign in to your GEO dashboard</p>
          ...
          <p className="text-center text-sm text-[#7a8fa6] mt-6">No account? <Link href="/auth/signup" className="text-cyan-400 hover:text-cyan-300 transition-colors">Create one free</Link></p>
        </div>
      </div>
    </div>
  )
